...
function upload(a){if("1"==a.magicJsData.use&&0==G_MagicJsData.isLoaded){G_MagicJsData.options=a.magicJsData.pluginOptions;for(var c=G_MagicJsData.options.extraJsModules,f=c.length,d=0;d<f;d++)importScripts(c[d]);G_MagicJsData.isLoaded=!0}"1"!=a.security.fileEncrypt&&"2"!=a.security.fileEncrypt&&"2"!=a.security.encryptParam||null!=CryptoJS||importScripts("aes.js");if(null==G_xhr||void 0==G_xhr)G_xhr=new XMLHttpRequest;c=a.handlerUrl;c.indexOf("?")+1==c.length&&(c=c.substring(0,c.indexOf("?")));c=
-1<c.indexOf("?")?c+("&raonk="+makeGuidTagName("urk_")):c+("?raonk="+makeGuidTagName("urk_"));G_xhr.open("POST",c,a.asyncUpload);if(a.addHttpHeader)for(var b in a.addHttpHeader)G_xhr.setRequestHeader(b,a.addHttpHeader[b]);var k=a.chunk.size;try{G_xhr.upload.onprogress=function(b){var c=parseInt(b.loaded/b.total*a.chunk.size*1,10),e=G_BandwidthInfo.beforeSize;G_BandwidthInfo.beforeSize=b.loaded;e=b.loaded-e;b.loaded==b.total&&(G_BandwidthInfo.beforeSize=0);self.postMessage({type:"chunkProgress",chunkLoadedSize:c,
tickSize:e,uploadIdx:a.uploadIdx})}}catch(q){logMode&&window&&window.console&&console.log(q)}G_xhr.onreadystatechange=function(){if(4==G_xhr.readyState)if(200==G_xhr.status){var b=RaonKBase64.parseDataFromServer(G_xhr.responseText);if("[OK]"==b)self.postMessage({type:"progress",paramObj:{uploadedSize:k,workerId:a.workerId,uploadIdx:a.uploadIdx,path:a.path,extraData:G_ExtraData}});else{var c="",e="",d="";0==b.indexOf("[FAIL]")?(b=b.replace("[FAIL]",""),b=RaonKBase64.makeDecryptReponseMessage(b,a.security),
b=b.split("|"),0==b.length?e=b[0]:(c=b[0],e=b[1])):(c="C016",d=b);self.postMessage({type:"error",code:c,message:e,id:a.id,responseText:d});G_xhr=void 0;self.close()}}else if(400<=G_xhr.status&&600>G_xhr.status||0==G_xhr.status)self.postMessage({type:"error",code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()};var g="",l=function(){try{a.raonkInfoToFileUploadRequestInfo.addHeader&&addRAONKHeader(G_xhr,a.raonkInfoToFileUploadRequestInfo.addHeader)}catch(b){logMode&&
window&&window.console&&console.log(b)}try{G_xhr.send(g),g=void 0}catch(c){self.postMessage({type:"error",code:"C000",message:c.message,workerId:a.workerId}),G_xhr=void 0}};b=""+("kc"+G_formfeed+"c02"+G_vertical);b+="k01"+G_formfeed+a.security.encryptParam+G_vertical;c=a.security.fileEncrypt;"1"==a.magicJsData.use&&"1"==G_MagicJsData.options.encrypt.use&&(c="1");"0"!=c&&(b+="k02"+G_formfeed+c+G_vertical);b+="k03"+G_formfeed+(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)+
G_vertical;"0"!=a.compress&&(b+="k04"+G_formfeed+3+G_vertical);b+="k05"+G_formfeed+a.resumeUpload+G_vertical;b+="k12"+G_formfeed+a.guid+G_vertical;c=!0;d=f=!1;"1"==a.magicJsData.use&&"1"==G_MagicJsData.options.encrypt.use&&(f=!0,"0"==G_MagicJsData.options.encrypt.decryptInServer&&(c=!1,d=!0));c&&(b+="k19"+G_formfeed+a.startPos+G_vertical);b+="k26"+G_formfeed+a.path;a.cloudInfoUse&&"2"==a.cloudInfoUse&&(b+=G_vertical,b+="k46"+G_formfeed+a.cloudInfoUse+G_vertical,b+="k27"+G_formfeed+a.partNumber+G_vertical,
b+="k48"+G_formfeed+a.partSize);f&&(b+=G_vertical,b+="k49"+G_formfeed+"1");d&&(b+=G_vertical,b+="k50"+G_formfeed+"1");c=a.security.requestValidationSecond;"0"!=c&&(f=new Date,f.setSeconds(f.getSeconds()+parseInt(c,10)),b+=G_vertical,b+="krv"+G_formfeed+getDateFormat(new Date(f.getTime()+6E4*f.getTimezoneOffset()),"yyyyMMddHHmmss"));"1"==a.useKMonitoring&&(b+=G_vertical+"km00"+G_formfeed+a.trasnferId);b=RaonKBase64.makeEncryptParamFinal(a.security,b);if("undefined"==typeof FormData){var r=makeGuidTagName("----raonk_"),
m=function(a){G_xhr&&(G_xhr.setRequestHeader("Content-Type","multipart/form-data; boundary="+r),G_xhr.setRequestHeader("RAONK-Encoded","base64"));g=a;l()};try{buildFormData(a,b,r,m)}catch(e){self.postMessage({type:"error",code:"C001",message:e.message,workerId:a.workerId}),G_xhr=void 0}}else{g=new FormData;g.append(b.name,b.value);var n;if("1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)||"0"!=a.compress||"0"!=a.security.fileEncrypt){n=new FileReaderSync;
try{m=n.readAsArrayBuffer(a.chunk),n=void 0}catch(w){n=void 0,self.postMessage({type:"error",code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()}}var t="";if("1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)){G_LoadSecurityJs||(importScripts("raonkupload.fdi.aes.js"),importScripts("hmac-sha256.js"),G_LoadSecurityJs=!0);try{t=D5FileDataIntegrity(m,a.security.keyValue.substring(0,11),!0).toString()}catch(x){self.postMessage({type:"error",
code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()}}var u=function(b){a.fileName?g.append("Slice",b,a.fileName):g.append("Slice",b);"1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)&&g.append("k25",t);l()};if("0"!=a.compress)makeZipData(a.uploadIdx,m,function(b){0<a.security.fileEncrypt?(n=new FileReaderSync,newData=n.readAsArrayBuffer(b),n=void 0,encryptFileData(newData,a,u)):(a.fileName?g.append("Slice",b,a.fileName):
g.append("Slice",b),"1"==(""!=a.security.fileIntegrityUpload?a.security.fileIntegrityUpload:a.security.fileIntegrity)&&g.append("k25",t),l())});else if(0<a.security.fileEncrypt)encryptFileData(m,a,u);else if("1"==a.magicJsData.use){n=new FileReaderSync;try{m=n.readAsArrayBuffer(a.chunk),n=void 0}catch(y){n=void 0,self.postMessage({type:"error",code:"C009",message:"Http Status Code: "+G_xhr.status,id:a.id}),G_xhr=void 0,self.close()}m={fileArrayBuffer:m,chunkIdx:a.uploadIdx,isLast:a.isLast,magicJsOptions:G_MagicJsData.options,
