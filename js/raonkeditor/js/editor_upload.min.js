...
0==a.indexOf("[OK]")?(a=a.replace("[OK]",""),a=KEDITORTOP.RAONKEDITOR.util.makeDecryptReponseMessage(a)):0==a.indexOf("[FAIL]")&&(a=a.replace("[FAIL]",""),a="[FAIL]"+KEDITORTOP.RAONKEDITOR.util.makeDecryptReponseMessage(a))):a="[FAIL]File Upload Error";b=null;loading_image_show(!1);d(a)}};b.onerror=function(){b=null;loading_image_show(!1);d("[FAIL]File Upload Error")};var c=new FormData;a.formData&&0<a.formData.length&&a.formData.each(function(a,b){c.append(a,b)});a.fileObj&&c.append(a.fileID,a.fileObj[0]);
